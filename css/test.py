...
get_id('https://www.youtube.com/watch?v=Z3QbYaAAuAw&list=PLR2RsKKRngz6vSNlXJJXj6slpmKNgztNi&index=4')
    ...
    if(request.method == 'GET'):
        ...
        while True:
            ...
            if 'nextPageToken' in results and cnt < 500:
                ...
                display_text += ['No of videos : ' + str(cnt), 
...
def static_from_root():
    return Response('This is a Brave Rewards publisher verification file.\n\nDomain: ytplaylist-len.herokuapp.com\nToken: aae68b8a5242a8e5f0505ee6eaa406bd51edf0dc9a05294be196495df223385c', mimetype='text/plain')
